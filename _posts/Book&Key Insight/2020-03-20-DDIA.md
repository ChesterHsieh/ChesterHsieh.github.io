...
- No longer need to store whole key-value index. Even the key which we are int

There's following problem is that we need to remake our wrirtting process. 


# CH4
<!--stackedit_data:
eyJoaXN0b3J5IjpbODg5NTcxNjk3LC0yOTEwMDI1MTQsMTk2OD
