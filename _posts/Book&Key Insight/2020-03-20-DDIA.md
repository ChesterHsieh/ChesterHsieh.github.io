...
**H**owever following problem is that we need to remake our wrirtting process. 
Create Btree/LSMtree in memory. Once the data structure over some thershold, write the whole tree into disk, sequential writting definetly. 

# CH4
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTUzMDgyMDI3LC0yOTEwMDI1MTQsMTk2OD
QzNzQyMiwtMTk1NTEyODc3NCwtNDYzNjA5OTc1XX0=
-->