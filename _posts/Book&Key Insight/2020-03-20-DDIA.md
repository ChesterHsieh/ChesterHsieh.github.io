...
Create Btree/LSMtree in memory. Once the data structure over some thershold, write the whole tree into disk, of couse, 

# CH4
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTE5NDk0MzEwNCwtMjkxMDAyNTE0LDE5Nj
