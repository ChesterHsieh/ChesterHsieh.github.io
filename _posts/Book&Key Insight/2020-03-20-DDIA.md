...
LSM tree/ SStable
## SSTable/LSMtree
***Sorted string table***: Keys are stroed as string. Once we store the key by its key sequence. Boom! the SSTable come out as solution. There's following problem is that we need to remake our wrirtting process. 


# CH4
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEyODA4NDU0NiwtMjkxMDAyNTE0LDE5Nj
g0Mzc0MjIsLTE5NTUxMjg3NzQsLTQ2MzYwOTk3NV19
-->