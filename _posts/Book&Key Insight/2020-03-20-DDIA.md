...
LSM tree/ SStable
## SSTable/LSMtree
***Sorted string table***: Keys are stroed as string. Once we store the key by its key sequence. Boom! the SSTable comeout 


# CH4
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTQyNTg5OTkzNywtMjkxMDAyNTE0LDE5Nj
