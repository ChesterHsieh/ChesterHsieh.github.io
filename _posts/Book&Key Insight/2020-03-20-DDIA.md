...
Main read pattern Transaction processing systems (OLTP)
Small number of records per query, fetched by key Analytic systems (OLAP)
...
# CH4
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE4MTU4MjM1NjIsLTU2NTQwODQ0NCwtMj
