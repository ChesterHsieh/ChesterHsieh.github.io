...
### Docker init
### Docker customized
[Docker hub](https://hub.docker.com/) is docker version github. Easy to share and easy to advanced them is the trend for now. We can also find tensorflow provide its hub web also. 
## CD-> App Engine 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbNDkxNDEwOTExLC0xNTM3OTI0NjEyLC04Nz
U2OTUwMDQsLTEyNTMxNTU5NDgsLTE3MjU5NzMyNTgsNDcyNzI4
MTA1XX0=
-->