...
- **Median**
	Hohohoho! This is not cute at all. Check *Leetcode569*. Take out the median, the question is super easy.  [Ref logica control](# Conditional control)
- **VAR/STDEV**
	More stats :)
